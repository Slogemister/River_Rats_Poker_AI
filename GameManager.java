...
public class GameManager {
    ...
    /*
     The main constructor for this class requires that five things be provided
     */
    public GameManager(Player[] players, Dealer dealer, boolean debug,
            int[] bets, int raiseLimit, int hands) {
